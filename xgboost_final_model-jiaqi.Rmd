---
title: "xgboost final model-jiaqi"
author: "Jiaqi Chen"
date: "2022-10-05"
output: pdf_document
---
...
<<<<<<< HEAD:xgboost_final_model-jiaqi.Rmd
...
# duplicate = duplicated(colnames(final))
# final = final[, !duplicate]
>>>>>>> 10da7943e4bbeaea86665377e54e9eb6dd181df7:xgboost_final_model.Rmd
```
...
## 0.7518  unbalanced data with imputation
```
...
write.csv(output,"2022CaseCompetition_Yiru_Gong_20221009.csv",row.names = F)
```
