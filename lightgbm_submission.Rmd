...
```{r}
grids_full = expand.grid(max_depth = c(1,3,5,7,9),
                # learning_rate = c(0.01,0.005),
                # min_sum_hessian_in_leaf = seq(0,1,0.1),  #seq(0.0005,0.01,0.002),
                feature_fraction = c(0.1,0.3,0.5,0.7,0.9),
                lambda_l1 = c(1.5,3,4.5,6),
                lambda_l2 = c(0.3,0.5),
...
grids = grids_full[sample(1:nrow(grids_full), 0.3*nrow(grids_full)),]
