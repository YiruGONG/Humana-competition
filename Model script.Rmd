...
train2 = train %>% 
>>>>>>> e0b6b8d614d6b283dd0575378e2a669faf2994d3
  mutate_if(is.factor,as.numeric) %>% 
  mutate(hi_flag = as.factor(hi_flag))
...
output = cbind(ID = holdout_id, 
               SCORE = lgb_pred,
               RANK = rank(-lgb_pred))
write.csv(output,"2022CaseCompetition_Yiru_Gong_20221003.csv",row.names = F)
```
