...
col_cat = heading[which(heading$data_type=='string'),]$feature_name
int_idx = c("cms_disabled_ind", "cons_hxmioc", "cons_hxmboh", "cons_stlnindx", "cmsd2_men_mad_ind", "cms_dual_eligible_ind", "cons_stlindex", "cms_low_income_ind", "cons_hxmh", "cms_frailty_ind")
>>>>>>> c032b48032e572e46fdb94ade6eb1cb46c27935b
...
=======
save(x,y,x2,y2,rowTrain, final, cat_idx, file = "split_data.Rdata")
>>>>>>> c032b48032e572e46fdb94ade6eb1cb46c27935b
...
* Final balanced dataset: data.rose
...
balanced_final_matrix = model.matrix(hi_flag ~., data.rose)[ , -1]
...
score <- model.nn %>% evaluate(test_data, test_labels)
score
```
