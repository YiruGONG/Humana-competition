...
data_num <- new_full[ ,unlist(lapply(new_full, is.numeric))]
cat = new_full[ ,unlist(lapply(new_full, is.factor))]
...
save(final,rowTrain,cat_idx2,file = "final_na_enlarged.Rdata")
